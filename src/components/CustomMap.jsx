...
const CustomMap = () => {
  ...
  const trees = [
    ...
    },
    {
      ...
      species: "Peumo",
      age: 54,
      datePlanted: "1970-08-25",
      lastMaintenance: "2024-02-18",
      alertState: "warning",
      coordinates: { x: 1220, y: 320 }
    },
    {
      id: 23,
      x: 780,
      ...
      species: "Maitén",
      age: 38,
      datePlanted: "1986-05-30",
      lastMaintenance: "2024-01-25",
      alertState: "normal",
      coordinates: { x: 780, y: 850 }
    },
    {
      id: 24,
      x: 1250,
      ...
      species: "Boldo",
      age: 45,
      datePlanted: "1979-09-18",
      lastMaintenance: "2024-03-08",
      alertState: "critical",
      coordinates: { x: 1250, y: 600 }
    },
    {
      id: 25,
      x: 760,
      ...
      species: "Quillay",
      age: 72,
      datePlanted: "1952-11-22",
      lastMaintenance: "2024-02-15",
      alertState: "good",
      coordinates: { x: 760, y: 520 }
    },
    {
      id: 26,
      x: 1240,
    ...
    },
    {
      ...
      species: "Maitén",
      age: 44,
      datePlanted: "1980-03-28",
      lastMaintenance: "2024-02-22",
      alertState: "good",
      coordinates: { x: 790, y: 750 }
    },
    {
      id: 28,
      x: 1230,
      ...
      species: "Boldo",
      age: 58,
      datePlanted: "1966-12-05",
      lastMaintenance: "2024-01-30",
      alertState: "normal",
      coordinates: { x: 1230, y: 440 }
    },
    {
      id: 29,
      x: 770,
      ...
      species: "Quillay",
      age: 64,
      datePlanted: "1960-06-18",
      lastMaintenance: "2024-03-15",
      alertState: "good",
      coordinates: { x: 770, y: 320 }
    },
    {
      id: 30,
      x: 1210,
      ...
      species: "Peumo",
      age: 56,
      datePlanted: "1968-10-08",
      lastMaintenance: "2024-02-28",
      alertState: "good",
      coordinates: { x: 1210, y: 680 }
    }
  ];
